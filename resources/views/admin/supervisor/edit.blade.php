            ...
            <div class="bg-white shadow-md rounded p-6">
                <form method="POST" action="{{ route('admin.supervisor.update', $supervisor->id) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" value="{{ $supervisor->name }}" class="form-input rounded-md shadow-sm mt-1 block w-full" required>
                    </div>

                    <div class="mb-4">
                        <label class="block font-medium text-sm text-gray-700">Email</label>
                        <input type="email" name="email" value="{{ $supervisor->email }}" class="form-input rounded-md shadow-sm mt-1 block w-full" required>
                    </div>
                    ...
                    <div class="flex justify-end gap-3 mt-3">
                        <x-primary-button>{{ __('Update Supervisor') }}</x-primary-button>
